...
const UpdateListing = () => {
    ...
    return (
        <main className='p-3 max-w-6xl mx-auto'>
            <h1 className='text-2xl text-green-700 font-semibold my-7 text-right'>Update this Listing !</h1>
            <div className='border border-[#F7DCB9] p-4 bg-[#F8EAD8]'>
                <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-8'>
                    ...
                    <button disabled={loading || uploading} className='bg-[#41B06E] w-[200px] text-[#FFF5E0] rounded-full self-center p-3 uppercase hover:opacity-95 disabled:opacity-80'>
                        {loading ? 'Editing...' : 'Edit a Listing'}
                    </button>
