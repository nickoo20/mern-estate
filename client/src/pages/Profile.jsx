...
import {updateUserStart, updateUserSuccess, updateUserFailure, 
  ...
  signOutUserStart, signInFailure, signInSuccess, signOutUserFailure, signOutUserSuccess} from '../redux/user/userSlice.js'
    ...
    <div className="p-3 max-w-lg mx-auto">
      ...
      <p>{showListingsError ? 'Error showing listings' : ''}</p>
      {
        ...
        <div className='flex flex-col gap-4'>
          <h1 className='text-2xl font-semibold mt-7 text-center'>Your Listings</h1>
          {userListings.map((listing) => (
            <div key={listing._id} className='flex rounded-lg p-3 border justify-between items-center gap-4'>
